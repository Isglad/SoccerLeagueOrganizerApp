...
//        return teams.stream().filter(t -> t.getTeamName().equalsIgnoreCase(name)).findFirst().orElse(null);
//    }

//    private Player findPlayerInDatabase(String name) {
//        for (Player : playerDatabase) {
//            if (player.getFirstName().equalsIgnoreCase(name) && player.getLastName().equalsIgnoreCase(name)) {
//                return player;
//            }
//        }
//        return null;
...
//            Player player = playerDatabase[i];
//            String experience = player.isPreviousExperience() ? "experienced" : "inexperienced";
...
//    Helper method to select a team
//    private Team selectTeam(){
//        //  Display existing teams and prompt for selection
//        if(teams.isEmpty()){
...
//            System.out.printf("%d.) %s (Coach: %s)%n", i + 1, teams.get(i).getTeamName(), teams.get(i).getTeamCoach());
//        }
//
//        System.out.print("Enter the number of the team to add a player to: ");
...
//    Helper method to display players of a team and select one
//    private Player displayAndSelectPlayer(Team team) {
//       // List<Player> players = (List<Player>) team.getTeamPlayers();
